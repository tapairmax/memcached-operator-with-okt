...
func main() {
	...
	// REPLACED4OKT: Fields Client, Log ans Scheme are not accessible that way here in external module.
	...
	r.Log = ctrl.Log.WithName("controllers").WithName("Memcached")
	...
	/* DEACTIVATED because of cert manager requirements
